...
| #    | Item                                                           | Owner    | Est. | DoD                                                                                                                               |
| ---- | -------------------------------------------------------------- | -------- | ---- | --------------------------------------------------------------------------------------------------------------------------------- |
| S8-1 | **Creating an assessment, in the product**                     | frontend | M    | A teacher sets one up from the class screen. The end-to-end test drives the form rather than the API — the reason this was missed |
