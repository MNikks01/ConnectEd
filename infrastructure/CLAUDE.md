...
| Dir                  | Contents                                                                                                                                                                                                        |
| -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docker/`            | Multi-stage Dockerfiles: `api.Dockerfile` (API, worker **and** the migration runner — three targets, one source) and `web.Dockerfile`. Non-root, no dev dependencies, built and scanned by the `images` CI job. |
