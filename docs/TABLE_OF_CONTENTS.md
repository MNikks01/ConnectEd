...
- "Class" in the academic sense = a specific **Medium + Class + Section** combination (e.g. _English Medium · Class 5 · Section A_), which the code encodes as a single key such as `EngClass5SecA`.
