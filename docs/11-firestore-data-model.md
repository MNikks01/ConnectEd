...
- `USER_CURRENT_STATUS` — one of `STUDENT` · `PARENT` · `TEACHER` · `PRINCIPAL` · _(empty/undefined for a general "User")_
...
| Path                                                                   | Purpose                                             |
| ---------------------------------------------------------------------- | --------------------------------------------------- |
| _(class doc)_                                                          | `SUBJECTS_LIST` and class metadata                  |
...
_(Analogous `VERIFICATION_REQUESTS` / `VERIFIED_MEMBERS` paths exist for teachers and principal, split by subject where relevant.)_
